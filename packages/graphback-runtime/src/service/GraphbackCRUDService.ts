...
export interface GraphbackCRUDService<Type = any, GraphbackContext = any> {
  setModelConfig(modelType: GraphQLObjectType, pubSubConfig: GraphbackPubSubModel): void
  setDataProvider(dataProvider: GraphbackDataProvider): void
  getDataProvider(): GraphbackDataProvider
